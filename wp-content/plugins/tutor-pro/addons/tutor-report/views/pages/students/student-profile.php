            ...
            <div class="box-stats-text">
                <h3>
                    <?php 
                        ...
                        if ( false !== $enrolled_course && is_object( $enrolled_course ) && ! empty( $enrolled_course ) ) {
                    ...
                    foreach ($enrolled_course->posts as $course){ $counter++;
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="complete">
                                    <?php
                                        $total_quiz = (array) $wpdb->get_results(
                        ...
                        <!-- complete running incomplete -->
                            <td colspan="100%">
                                <div class="course-list-details">
                                            ...
                                            <div class="status">
                                                <?php 
                                                    ...
                                                    for($count; $count >= 0; $count--) {
                                                        ...
                                                        ?>
                                                        <span class="<?php echo ($is ? 'complete' : 'incomplete'); ?>">
                                                            <?php echo get_the_title($posts_data[$count]->ID); ?>
                                                        </span><br>
                                                        <?php 
                                                    } 
                                                ?>
                                    ...
                                    <?php 
                                        $assignment_ids_array = tutor_utils()->get_course_content_ids_by('tutor_assignments', tutor()->course_post_type, $course->ID);
                                    ?>

                                    <?php if(count($assignment_ids_array) > 0): ?>
                                        <div class="detail">
                                            <div class="heading"><?php _e('Assignment', 'tutor-pro'); ?></div>
                                            <div class="status">
                                                <?php foreach ($assignment_ids_array as $id) : ?>
